...
│   │   └── routes/
│   │       └── query.py         ← POST /api/query; UUID v4 thread_id validator; 60s timeout; 429/503/504
│   ├── tests/
...
- Move circuit breaker state to Redis for consistency across multiple backend replicas.
