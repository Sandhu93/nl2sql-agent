...
def _build_few_shot_prompt() -> ChatPromptTemplate:
    ...
    system_prompt = (
        ...
        "It does NOT reflect current squad rosters, player transfers, retirements, or auction results. "
        "'Current team' queries should use the most recent playing_xi entry "
        "(ORDER BY year DESC, match_id DESC LIMIT 1) and are accurate only up to the last season "
        "in the dataset. Never imply real-time accuracy.\n\n"
        ...
        "a descriptive string explaining what is missing, e.g.: "
